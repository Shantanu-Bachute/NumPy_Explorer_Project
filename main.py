...
def max_productivity(data_frame):
    ...
    print(
        f"The best company is the {best_company}. company "
        f"with {num_of_products} products made"
    )
...
def min_productivity(data_frame):
    ...
    print(
        f"The best company is the {worst_company}. company "
        f"with {num_of_products} products made"
    )
...
def mean_products(data_frame):
    for i in range(len(data_frame)):
        ...
        print(
            f"On average, one human from {i + 1}. company "
            f"produced {average} products"
        )
